...
router.post('/global', (req, res) => {
    ...
    const socket = io('http://localhost:5000/socket.io/?EIO=3&transport=polling&t=NyFbZRB', {
      withCredentials: true,
      extraHeaders: {
        "my-custom-header": "abcd"
      },
    });
    if (req.body.body == "") { return res.status(400).send({message : "cant send empty message"})}
