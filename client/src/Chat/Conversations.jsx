...
const Conversations = (props) => {
  ...
  useEffect(() => {
    getConversations().then((res) =>{const n =res.sort(compare);setConversations(n)} );
      ...
      {conversations && (
        <React.Fragment>
          {conversations? conversations.map((c) => (
            ...
            >
              <ListItemAvatar>
                <Avatar src={handleRecipient(c.recipientObj).pic} >
